...
export default function Footer() {
  const productLinks = [
    ...
    { name: 'Pin Akrilik Custom', href: '/produk/pin-akrilik-custom' },
  ];
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <a 
                    href="mailto:teknikpin45@gmail.com?subject=Konsultasi%20Pin%20Custom&body=Halo%20Pin%20Custom%20Bandung,%0A%0ASaya%20ingin%20konsultasi%20mengenai%3A%0A%0ATerima%20kasih."
                    className="text-white hover:text-blue-400 font-semibold"
                  >
                    teknikpin45@gmail.com
                  </a>
                </div>
              </div>
              
              {/* Location - Now Clickable to Google Maps */}
              <div className="flex items-start space-x-3 md:col-span-2">
                ...
                <div>
                  ...
                  <a 
                    href="https://maps.google.com/maps?q=Jl.+Desa,+No.+48,+RT+06,+RW+02,+Kel.+Babakan+Sari,+Kec.+Kiaracondong,+Kota+Bandung"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white hover:text-blue-400 transition-colors duration-300"
                  >
                    Jl. Desa, No. 48, RT 06, RW 02, Kel. Babakan Sari, Kec. Kiaracondong, Kota Bandung
            ...
            <div className="flex space-x-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-green-600 hover:bg-white p-3 rounded-lg transition-colors duration-300 group"
                title="Kunjungi Toko Tokopedia Kami"
              >
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="22" height="20" viewBox="0 0 64 64" className="group-hover:fill-green-600 fill-white">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-orange-600 hover:bg-white p-3 rounded-lg transition-colors duration-300 group"
                title="Kunjungi Toko Shopee Kami"
              >
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 50 50" className="group-hover:fill-orange-600 fill-white">
