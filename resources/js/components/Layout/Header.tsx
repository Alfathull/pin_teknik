...
export default function Header() {
  ...
  return (
    <header className="bg-gray-900 shadow-sm sticky top-0 z-50 py-4">
        ...
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-green-600 text-white block px-3 py-2 rounded-lg text-base font-medium hover:bg-green-700 mx-3 mt-4 text-center"
            >
